...
نسخهٔ جاری پروژه **ZarGard Android 0.10.0** است. **[دانلود مستقیم APK نسخهٔ 0.10.0](https://github.com/pouriaquant91/gold-arbitrager-android/releases/download/android-v0.10.0/ZarGard-android-0.10.0-beta.apk)** برای نصب روی گوشی در دسترس است؛ همهٔ انتشارها نیز در صفحهٔ [Releases](https://github.com/pouriaquant91/gold-arbitrager-android/releases) نگهداری می‌شوند.
