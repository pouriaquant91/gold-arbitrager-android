...
- موجودی و تاریخچهٔ Paper Test خودکار مشترک با PWA و Core روی سرور
...
نسخهٔ جاری پروژه **ZarGard Android 0.12.0** است. [دانلود مستقیم APK نسخهٔ 0.12.0](https://github.com/pouriaquant91/gold-arbitrager-android/releases/download/android-v0.12.0/ZarGard-android-0.12.0-beta.apk) پس از تکمیل انتشار در دسترس است.
