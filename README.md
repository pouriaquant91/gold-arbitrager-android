...
**[دانلود مستقیم ZarGard Android 0.8.1 Beta](https://github.com/pouriaquant91/gold-arbitrager-android/releases/download/android-v0.8.1/ZarGard-android-0.8.1-beta.apk)**

نسخهٔ ۰٫۸٫۱ تترگلد را از مسیر فعال حذف کرده و رابط را روی مقایسهٔ مستقیم طلای ۱۸ عیار، پایش برگشت جهت و مدل موجودی دوطرفه متمرکز می‌کند. طراحی پیش‌فرض Obsidian + Champagne، تم روشن/تیره/سیستم، سبک کامل Midnight Navy + Warm Gold و قفل اثر انگشت هماهنگ‌اند.
