...
- آستانهٔ پویا و قابل تنظیم با پیش‌فرض ۵٪ از مبلغ کمتر دو سمت
- موجودی و تاریخچهٔ معاملات آزمایشی مشترک با PWA و Core روی سرور
...
نسخهٔ جاری پروژه **ZarGard Android 0.11.0** است. **[دانلود مستقیم APK نسخهٔ 0.11.0](https://github.com/pouriaquant91/gold-arbitrager-android/releases/download/android-v0.11.0/ZarGard-android-0.11.0-beta.apk)** برای نصب روی گوشی در دسترس است؛ همهٔ انتشارها نیز در صفحهٔ [Releases](https://github.com/pouriaquant91/gold-arbitrager-android/releases) نگهداری می‌شوند.
