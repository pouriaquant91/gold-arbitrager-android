...
> این نسخه محاسبات پذیرفته‌شده را در دفتر داخلی سرور ثبت می‌کند. اتصال سفارش واقعی به حساب پلتفرم‌ها تا زمان تأیید API معاملاتی، پیش‌نمایش سفارش و مجوز هر پلتفرم عمداً خاموش است.

## آنچه اکنون کار می‌کند

- رابط مدرن Jetpack Compose با طراحی سبز تیره/طلایی و ناوبری کامل
...
- آستانهٔ پویا با پیش‌فرض ۰٫۵٪ از مبلغ کمتر دو سمت؛ تغییر فقط برای root
- موجودی و تاریخچهٔ محاسبات خودکار استراتژی، مشترک با PWA و Core روی سرور
- ثبت‌نام، ورود و ویرایش پروفایل مستقل از ChatGPT برای لایسنس آینده
- حذف کامل دکمه‌های ثبت خرید/فروش کاربر؛ اپ فقط نمایش و مدیریت حساب است
- نمایش پوشش هماهنگ با وب: ۵۳ سکوی شناسایی‌شده، ۳۰ collector پیاده‌سازی‌شده، ۲۶ پاسخ پذیرفته‌شده و ۱۶ مورد بدون feed معتبر
...
نسخهٔ جاری پروژه **ZarGard Android 0.14.0** است. [دانلود مستقیم APK نسخهٔ 0.14.0](https://github.com/pouriaquant91/gold-arbitrager-android/releases/download/android-v0.14.0/ZarGard-android-0.14.0-beta.apk) پس از تکمیل انتشار در دسترس است. این نسخه علاوه بر درصد قابل‌ویرایش، نمایش همهٔ منابع، اثر انگشت و سود/زیان هر پلتفرم، نمای جفت‌ها و تاریخچهٔ محاسبات و سفارش‌های مشترک سرور را اضافه می‌کند.
