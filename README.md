...
نسخهٔ جاری پروژه **ZarGard Android 0.13.0** است. [دانلود مستقیم APK نسخهٔ 0.13.0](https://github.com/pouriaquant91/gold-arbitrager-android/releases/download/android-v0.13.0/ZarGard-android-0.13.0-beta.apk) پس از تکمیل انتشار در دسترس است. این نسخه درصد سود آزاد و قابل‌ویرایش، نمایش همهٔ منابع، آیکون ثابت اثر انگشت، و سود/زیان هر پلتفرم نسبت به بودجه اولیه را با PWA و Core همگام می‌کند.
